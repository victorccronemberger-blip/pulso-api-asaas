...
import { createLearningStoreMethods } from "../learning/mysql-methods.js";
...
export function createMySqlStore(databaseUrl) {
  ...
  async function ensureSchema() {
    ...
    ready = (async () => {
      const statements = [
        ...
        `CREATE TABLE IF NOT EXISTS learning_courses (course_slug VARCHAR(80) PRIMARY KEY, title VARCHAR(180) NOT NULL, description TEXT NOT NULL, bunny_library_id VARCHAR(32) NULL, active TINYINT(1) NOT NULL DEFAULT 1, created_at DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3), updated_at DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3))`,
        `CREATE TABLE IF NOT EXISTS learning_entitlements (customer_id CHAR(36) NOT NULL, course_slug VARCHAR(80) NOT NULL, source VARCHAR(32) NOT NULL DEFAULT 'manual', active TINYINT(1) NOT NULL DEFAULT 1, expires_at DATETIME(3) NULL, created_at DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3), updated_at DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3), PRIMARY KEY (customer_id,course_slug), INDEX learning_entitlements_course (course_slug,active), CONSTRAINT learning_entitlements_customer_fk FOREIGN KEY (customer_id) REFERENCES customers(id) ON DELETE CASCADE, CONSTRAINT learning_entitlements_course_fk FOREIGN KEY (course_slug) REFERENCES learning_courses(course_slug) ON DELETE CASCADE)`,
        `CREATE TABLE IF NOT EXISTS learning_modules (id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY, course_slug VARCHAR(80) NOT NULL, title VARCHAR(180) NOT NULL, summary VARCHAR(500) NULL, sort_order SMALLINT UNSIGNED NOT NULL, created_at DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3), updated_at DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3), UNIQUE INDEX learning_modules_course_order (course_slug,sort_order), CONSTRAINT learning_modules_course_fk FOREIGN KEY (course_slug) REFERENCES learning_courses(course_slug) ON DELETE CASCADE)`,
        `CREATE TABLE IF NOT EXISTS learning_lessons (id VARCHAR(96) PRIMARY KEY, course_slug VARCHAR(80) NOT NULL, module_id BIGINT UNSIGNED NOT NULL, title VARCHAR(220) NOT NULL, bunny_video_id CHAR(36) NULL, duration_seconds INT UNSIGNED NOT NULL DEFAULT 0, material_path VARCHAR(500) NULL, sort_order SMALLINT UNSIGNED NOT NULL, published TINYINT(1) NOT NULL DEFAULT 1, created_at DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3), updated_at DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3), UNIQUE INDEX learning_lessons_course_order (course_slug,sort_order), INDEX learning_lessons_module_order (module_id,sort_order), CONSTRAINT learning_lessons_course_fk FOREIGN KEY (course_slug) REFERENCES learning_courses(course_slug) ON DELETE CASCADE, CONSTRAINT learning_lessons_module_fk FOREIGN KEY (module_id) REFERENCES learning_modules(id) ON DELETE CASCADE)`,
        `CREATE TABLE IF NOT EXISTS learning_progress (customer_id CHAR(36) NOT NULL, lesson_id VARCHAR(96) NOT NULL, position_seconds INT UNSIGNED NOT NULL DEFAULT 0, completed TINYINT(1) NOT NULL DEFAULT 0, updated_at DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3), PRIMARY KEY (customer_id,lesson_id), INDEX learning_progress_customer_updated (customer_id,updated_at), CONSTRAINT learning_progress_customer_fk FOREIGN KEY (customer_id) REFERENCES customers(id) ON DELETE CASCADE, CONSTRAINT learning_progress_lesson_fk FOREIGN KEY (lesson_id) REFERENCES learning_lessons(id) ON DELETE CASCADE)`,
        `CREATE TABLE IF NOT EXISTS learning_quizzes (id VARCHAR(96) PRIMARY KEY, course_slug VARCHAR(80) NOT NULL, lesson_id VARCHAR(96) NULL, title VARCHAR(220) NOT NULL, kind VARCHAR(24) NOT NULL, time_limit_minutes SMALLINT UNSIGNED NULL, passing_score_bps SMALLINT UNSIGNED NOT NULL DEFAULT 7000, sort_order SMALLINT UNSIGNED NOT NULL, published TINYINT(1) NOT NULL DEFAULT 1, created_at DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3), updated_at DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3), INDEX learning_quizzes_course_order (course_slug,sort_order), CONSTRAINT learning_quizzes_course_fk FOREIGN KEY (course_slug) REFERENCES learning_courses(course_slug) ON DELETE CASCADE, CONSTRAINT learning_quizzes_lesson_fk FOREIGN KEY (lesson_id) REFERENCES learning_lessons(id) ON DELETE SET NULL)`,
        `CREATE TABLE IF NOT EXISTS learning_questions (id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY, quiz_id VARCHAR(96) NOT NULL, external_code VARCHAR(80) NULL, prompt TEXT NOT NULL, explanation TEXT NULL, sort_order SMALLINT UNSIGNED NOT NULL, INDEX learning_questions_quiz_order (quiz_id,sort_order), CONSTRAINT learning_questions_quiz_fk FOREIGN KEY (quiz_id) REFERENCES learning_quizzes(id) ON DELETE CASCADE)`,
        `CREATE TABLE IF NOT EXISTS learning_question_options (id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY, question_id BIGINT UNSIGNED NOT NULL, body TEXT NOT NULL, is_correct TINYINT(1) NOT NULL DEFAULT 0, sort_order TINYINT UNSIGNED NOT NULL, INDEX learning_options_question_order (question_id,sort_order), CONSTRAINT learning_options_question_fk FOREIGN KEY (question_id) REFERENCES learning_questions(id) ON DELETE CASCADE)`,
        `CREATE TABLE IF NOT EXISTS learning_quiz_attempts (id CHAR(36) PRIMARY KEY, customer_id CHAR(36) NOT NULL, quiz_id VARCHAR(96) NOT NULL, correct_answers SMALLINT UNSIGNED NOT NULL, total_questions SMALLINT UNSIGNED NOT NULL, score_bps SMALLINT UNSIGNED NOT NULL, answers_json JSON NOT NULL, completed_at DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3), INDEX learning_attempts_customer_quiz (customer_id,quiz_id,completed_at), CONSTRAINT learning_attempts_customer_fk FOREIGN KEY (customer_id) REFERENCES customers(id) ON DELETE CASCADE, CONSTRAINT learning_attempts_quiz_fk FOREIGN KEY (quiz_id) REFERENCES learning_quizzes(id) ON DELETE CASCADE)`,
      ];
  ...
  return {
    ...
    ...createLearningStoreMethods({ pool, ensureSchema, id, asJson, iso }),
